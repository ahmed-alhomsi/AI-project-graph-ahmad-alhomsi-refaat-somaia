const graph = {
  ...
  function aStar(graph, start, goal, heuristic) {
    ...
    while (queue.length > 0) {
      ...
      if (node === goal) {
        ...
        // console.log(`A* Path from S to G: ${path.join(' -> ')}`);
        // console.log(`Total Cost: ${cost}`);
        // console.log(`Heuristic Value: ${heuristicValue}`);
  ...
  // if (dfsResult.path.length > 0) {
  //   console.log(`DFS Path from ${startNode} to ${goalNode}: ${dfsResult.path.join(' -> ')}`);
  //   console.log(`Total Cost: ${dfsResult.cost}`);
  // } else {
  //   console.log(`No path found from ${startNode} to ${goalNode} using DFS.`);
  // }
  
  const bfsResult = bfs(graph, startNode, goalNode);
  
  // if (bfsResult.path.length > 0) {
  //   console.log(`BFS Path from ${startNode} to ${goalNode}: ${bfsResult.path.join(' -> ')}`);
  //   console.log(`Total Cost: ${bfsResult.cost}`);
  // } else {
  //   console.log(`No path found from ${startNode} to ${goalNode} using BFS.`);
  // }
  ...
  // if (ucsResult.path.length > 0) {
  //   console.log(`UCS Path from ${startNode} to ${goalNode}: ${ucsResult.path.join(' -> ')}`);
  //   console.log(`Total Cost: ${ucsResult.cost}`);
  // } else {
  //   console.log(`No path found from ${startNode} to ${goalNode} using UCS.`);
  // }